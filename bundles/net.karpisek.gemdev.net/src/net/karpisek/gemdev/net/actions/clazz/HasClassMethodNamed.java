 ...
 */
public class HasClassMethodNamed extends SessionAction<Boolean> {
	private final String className;
	private final boolean instanceSide;
	private final String categoryName;

	public HasClassMethodNamed(final String className, final boolean instanceSide, final String categoryName) {
