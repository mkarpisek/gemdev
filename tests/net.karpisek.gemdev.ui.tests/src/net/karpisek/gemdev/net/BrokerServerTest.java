...
public class BrokerServerTest {
	...
	@Test
	public void testCheckConnection_invalidIpAddress() throws Exception {
		assertEquals("Failed to connect to broker server.", BrokerServer.checkConnection("0.0.0.0", 0, VALID));
	}

	@Test
	public void testCheckConnection_invalidPassword() throws Exception {
	...
	@Test
	public void testCheckConnection_invalidProfileName() throws Exception {
	...
	@Test
	public void testCheckConnection_invalidUsername() throws Exception {
