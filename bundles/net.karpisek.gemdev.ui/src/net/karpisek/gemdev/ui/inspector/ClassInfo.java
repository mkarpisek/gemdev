 ...
 */
public class ClassInfo extends ObjectInfo {
	public ClassInfo(final ISession session, final String oop, final String className, final String printString, final int namedVarSize,
